...
public class scrollingBackground {
	...
	public scrollingBackground () {
		...
		imageScale = horrorRPG.WIDTH / image.getWidth();
		speedFixed = true;
	}
	...
	public void updateAndRender (float deltaTime, SpriteBatch batch) {
		...
		//Render
		batch.draw(image, 0, y1, horrorRPG.WIDTH, image.getHeight() * imageScale);
		batch.draw(image, 0, y2, horrorRPG.WIDTH, image.getHeight() * imageScale);
	}
